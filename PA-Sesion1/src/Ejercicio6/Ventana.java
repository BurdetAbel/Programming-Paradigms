// En el Ejemplo 3, hacer que los botones cambien de color siguiendo la secuencia: se pintan de negro durante un tiempo aleatorio que varía
// entre un mínimo de 2 y un máximo de 4 segundos. A continuación, obtienen un color al azar entre rojo, verde, azul y amarillo y se pintan
// con ese color durante un tiempo aleatorio entre 3 y 5 segundos, y vuelven a empezar el ciclo. (Para ello el thread tiene que detenerse
// (sleep()) durante los tiempos requeridos)
package Ejercicio6;
...
public class Ventana extends JFrame {
    ...
    public Ventana() {
        ...
        // Creamos un Pintor para cada botón, cada hilo controla su botón de forma independiente
        new Pintor(jButton1);
        new Pintor(jButton2);
        new Pintor(jButton3);
        new Pintor(jButton4);
    ...
    //public static void main(String args[]) {
        //java.awt.EventQueue.invokeLater(() -> new Ventana());
   // }
}
}
