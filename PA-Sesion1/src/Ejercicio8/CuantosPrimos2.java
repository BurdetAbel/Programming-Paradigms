// Tras realizar y ejecutar el Ejemplo 2, modificar las llamadas a los métodos “start()” por “run()” y observar la diferencia en el tiempo
// empleado. ¿Qué ocurre? 

// start() 664580 calculado en 1459 miliseg.
// run() 664580 calculado en 4550 miliseg. Cambiar start() por run() desactiva la concurrencia, todo se vuelve secuencial, por lo que el tiempo es mayor.
package Ejercicio8;
...
public class CuantosPrimos2 {
    public static void main(String[] x){
           ...
           System.out.println("CON HILOS Número de primos menores que 10.000.000: "+ n +" calculado en "+ (t1-t0) +" miliseg.");
    }
}